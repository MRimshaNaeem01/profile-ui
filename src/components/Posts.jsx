import { HeartOutlined, MessageFilled, MessageOutlined, ShareAltOutlined } from '@ant-design/icons'
  ...
  return (
    <>
      ...
      <div className='posts'>
        ...
        <Row className='writePost'>
          <Col span={1} xs={2} sm={2} md={1} lg={1} xl={1}>
          ...
          <Col span={22} xs={20} sm={20} md={22} lg={22} xl={22}>
            <Input className='postSome' placeholder='  Post something...' />
          </Col>
          <Col span={1} xs={2} sm={2} md={1} lg={1} xl={1}>
        ...
        <Row className='post1'>
          ...
          <Col span={24}>
            <p className="desc">
              Lorem autem itaque debitis, et ad incidunt adipisci!
        ...
        <Row className='post1'>
          ...
          <Row gutter={2} className='imagsRow' >
            <Col span={11} >
              <img className="imgs"
