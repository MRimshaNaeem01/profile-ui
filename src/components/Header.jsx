import { BellOutlined, MessageOutlined, SearchOutlined, PlusOutlined, DownOutlined, PrinterFilled } from '@ant-design/icons';
import { Button, Input, Space, Dropdown, Row, Col } from 'antd';
            ...
            <Row className="header">
                ...
                <Col span={8} className="search">
                        ...
                        <Input
                            ...
                            suffix={
                                <Dropdown menu={menuProps} className="drop">
                                    <Button style={{
                                        border: 'none',
                                        borderLeft: '1px solid gray', borderRadius: '100px'
                                    }}>
                                        <Space>
                                            <PrinterFilled />
                                            Canada
